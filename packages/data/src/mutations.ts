    ...
    mutationFn: async (input: NewAccount): Promise<Account> =>
      unwrap(
        await (c
          ...
          .select()
          .single() as unknown as SingleResult<Account>),
      ),
    ...
    mutationFn: async (id: string): Promise<void> => {
      unwrap(
        await (c
          ...
          .eq('id', id) as unknown as VoidResult),
      );
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: dataKeys.accounts() }),
  });
    ...
    mutationFn: async (input: NewCategory): Promise<Category> =>
      unwrap(
        await (c
          ...
          .insert(input as never)
          .select()
          .single() as unknown as SingleResult<Category>),
      ),
  ...
  mutationOptions({
    mutationFn: async (input: NewManualTransaction): Promise<Transaction> =>
      unwrap(
        await (c
          .from('transactions')
          .insert({ ...input, is_manual: true } as never)
          .select()
          .single() as unknown as SingleResult<Transaction>),
      ),
    ...
    mutationFn: async (input: { id: string; categoryId: string | null }): Promise<void> => {
      unwrap(
        await (c
          ...
          .eq('id', input.id) as unknown as VoidResult),
      );
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: dataKeys.transactions() }),
  });
